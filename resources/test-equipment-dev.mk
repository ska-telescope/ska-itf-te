...
COMMIT_HASH ?= 6e2e8fb5
TE_VERSION ?= 0.7.4-dev.c$(COMMIT_HASH) # This is the version of the image that we want to pull from https://gitlab.com/ska-telescope/ska-ser-test-equipment/container_registry/3213235
