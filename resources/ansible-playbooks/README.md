...
Makefile:setup_spfc_dry_run Runs the full playbook against the Raspberry Pi SPFC in dry-run mode.
Makefile:setup_spfc         Runs the full playbook against the Raspberry Pi SPFC.
