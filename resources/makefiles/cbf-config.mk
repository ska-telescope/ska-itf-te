...
itf-cbf-config-mcs: itf-cbf-copy-slim-config itf-cbf-copy-hw-config ## Copy the init sys params into the bite pod, copy the vcc gains json for band1 into the pod
	@kubectl cp $(MCS_CONFIG_FILE_PATH)/internal_params.json $(KUBE_NAMESPACE)/ds-vcc-vcc-0:/app/mnt/vcc_param/internal_params_receptor1_band1.json
...
itf-cbf-setup: itf-cbf-config-mcs  itf-cbf-tango-on
