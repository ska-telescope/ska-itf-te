...
deployment-images-check:
	...
	# @grep -oE 'image: [^ ]+' template.log | sed 's/image: //' | sed 's/"//g' | sort | uniq > expected-images.txt
	@awk '/name: / {name=$2} /image: / {print name ":" $2}' template.log | sort | uniq > expected-images.txt
