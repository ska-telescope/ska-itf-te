...
vars:
	...
	$(info TANGO_HOST=$(TANGO_HOST))
	$(info CLUSTER_DOMAIN=$(CLUSTER_DOMAIN))
	$(info TANGO_SERVER_PORT=$(TANGO_SERVER_PORT))
	$(info SKA_TANGO_OPERATOR=$(SKA_TANGO_OPERATOR))
	$(info DISPLAY=$(DISPLAY))
	$(info XAUTHORITY=$(XAUTHORITY))
	$(info JIVE=$(JIVE))
	$(info ITANGO_ENABLED=$(ITANGO_ENABLED))
	...
	$(info FEATURE_BRANCH_DEPLOYMENT=$(FEATURE_BRANCH_DEPLOYMENT))
	...
	$(info OVERRIDE_MULTISCAN_NUMBER_OF_SCANS=$(OVERRIDE_MULTISCAN_NUMBER_OF_SCANS))
	$(info OVERRIDE_MULTISCAN_DELAY_BETWEEN_SCANS=$(OVERRIDE_MULTISCAN_DELAY_BETWEEN_SCANS))
	$(info OVERRIDE_MULTISCAN_BANDS=$(OVERRIDE_MULTISCAN_BANDS))
	...
	$(info NODE_WITH_100G_INTERFACE=$(NODE_WITH_100G_INTERFACE))
	...
	$(info TEAPOT_PARAMS=$(TEAPOT_PARAMS))
	$(info TEAPOT_LMC_IN_THE_LOOP=$(TEAPOT_LMC_IN_THE_LOOP))
	$(info KIND_OF_TEA=$(KIND_OF_TEA))
	$(info DISH_VCC_CONFIG_SOURCE=$(DISH_VCC_CONFIG_SOURCE))
	$(info DISH_VCC_CONFIG_FILE_PATH=$(DISH_VCC_CONFIG_FILE_PATH))
	$(info TELMODEL_SOURCE=$(TELMODEL_SOURCE))	
	$(info TEAPOT_DATA_FILES=$(TEAPOT_DATA_FILES))
