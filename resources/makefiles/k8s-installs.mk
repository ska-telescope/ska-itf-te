...
vars:
	...
	$(info EXPOSE_All_DS=$(EXPOSE_All_DS) #global.exposeAllDS)
	$(info TANGO_HOST=$(TANGO_HOST) #global.tango_host)
	$(info CLUSTER_DOMAIN=$(CLUSTER_DOMAIN) #global.cluster_domain)
	$(info TANGO_SERVER_PORT=$(TANGO_SERVER_PORT) #global.device_server_port)
	$(info SKA_TANGO_OPERATOR=$(SKA_TANGO_OPERATOR) #global.operator)
	$(info DISPLAY=$(DISPLAY) #ska-tango-base.display)
	$(info XAUTHORITY=$(XAUTHORITY) #ska-tango-base.xauthority)
	$(info JIVE=$(JIVE) #ska-tango-base.jive.enabled)
	$(info ITANGO_ENABLED=$(ITANGO_ENABLED) #ska-tango-base.itango.enabled)
