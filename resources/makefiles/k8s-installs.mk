...
ODA_NAMESPACE=oda
itf-install-oda:
	make k8s-install-chart K8S_CHART=ska-db-oda KUBE_APP=oda KUBE_NAMESPACE=$(ODA_NAMESPACE) HELM_RELEASE=installing-oda

itf-uninstall-oda:
	@make k8s-uninstall-chart K8S_CHART=ska-db-oda KUBE_APP=oda KUBE_NAMESPACE=$(ODA_NAMESPACE) HELM_RELEASE=installing-oda
