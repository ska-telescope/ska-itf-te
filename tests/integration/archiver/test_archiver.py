...
def configure_attribute(
    ...
    :param event_subscriber: The event subscriber.
    :param strategy: The strategy to use.
    :param polling_period: The oolling period.
...
def test_config_attribute(attribute, strategy, polling_period, value):
    ...
    :param strategy: The configuration strategy to use.
    :param polling_period: The polling period to use.
