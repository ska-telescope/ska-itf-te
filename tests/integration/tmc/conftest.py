...
def _(telescope_handlers, receptor_ids, settings):
    ...
    dish_config_json["tm_data_sources"][0] = "car:ska-mid?27.3.1-rc.6-k-value-100-set#tmdata"
    ...
    if tmc_central_node.isDishVccConfigSet and raw_vcc_config:
        try:
            ...
            for receptor in RECEPTORS:
                if dish_vcc_config["dish_parameters"][receptor]["k"] != settings["expected_k_value"]:
