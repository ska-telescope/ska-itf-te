...
def test_tmc_start_up_telescope_mid():
    """Test the start up of the telescope in mid."""
...
def test_tmc_off_telescope_mid():
    """Test the telescope OFF in mid."""


@given("an TMC")
def a_tmc():
    """Verify the state of the TMC."""
    tel = names.TEL()
...
def a_telescope_with_csp_sdp_and_dish():
    """Verify that the Telescope consists of SDP, CSP and a Dish."""
    tel = names.TEL()
    sut_settings = conftest.SutTestSettings()
...
def a_telescope_with_sdp_csp_and_dish_on():
    """Verify that the Telescope consisting of SDP, CSP and a Dish, is ON."""
    tel = names.TEL()
    sut_settings = conftest.SutTestSettings()
...
def the_sdp_csp_and_dish_must_be_on(sut_settings: conftest.SutTestSettings):
    """
    Verify that the sdp, csp and dish are on.
...
def the_sdp_csp_and_dish_must_be_off(
    ...
    """
    Verify that the sdp, csp and dish are off.
